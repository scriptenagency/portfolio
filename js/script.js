...
function initCarousel() {
    ...
    const buttonMaterial = new THREE.MeshPhysicalMaterial({ color: 0x444444, transmission: 0.5, roughness: 0.1, thickness: 2.0, ior: 1.5, side: THREE.DoubleSide, transparent: true });
